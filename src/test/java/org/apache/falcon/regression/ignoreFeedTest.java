...
//		b.setInputFeedDataPath("/samarthData/${YEAR}/${MONTH}/${DAY}/${HOUR}/${MINUTE}");
//		
//		b.setProcessValidity(instanceUtil.getTimeWrtSystemTime(-3),
...
//		Thread.sleep(15000);			
//		
//		ArrayList<String> lateData = instanceUtil.getInputFoldersForInstance(Util.getProcessName(b
// .getProcessData()),
// 0, 1);
//		
...
//		{
//			lateData2.add(lateData.get(i).substring(0,lateData.get(i).indexOf("/samarthData/"))
// +"/ignoreFeed"+lateData
// .get(i).substring(lateData.get(i).indexOf("/samarthData/")));
//		}
//		
//		
