 ...
 * generated in the com.inmobi.qa.falcon.generated.feed package. 
...
public class ObjectFactory {
    ...
    private final static QName _Feed_QNAME = new QName("uri:falcon:feed:0.1", "feed");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.inmobi.qa.falcon.generated.feed
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "uri:falcon:feed:0.1", name = "feed")
