...
public class OozieUtil {
    ...
    public static void verifyNewBundleCreation(ColoHelper cluster,
                                               ...
                                               boolean matchInstances)
    throws OozieClientException, ParseException, JAXBException {
    ...
    throws OozieClientException, ParseException {
    ...
    public static String getCoordStartTime(ColoHelper colo, String entity,
                                           int bundleNo)
    throws JAXBException, OozieClientException, ParseException {
