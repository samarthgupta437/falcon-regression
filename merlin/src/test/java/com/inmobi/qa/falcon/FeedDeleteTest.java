...
//       Assert.assertTrue(feedStoreFinalState.equals(feedStoreInitialState),"The process store values are not the same!");
//       
...
//       Assert.assertEquals(feedArchiveFinalState.size(),1,"more than 1 different files were found!");
//       Assert.assertTrue(feedArchiveFinalState.get(0).contains(Util.readDatasetName(feed)),"seems like some other file was being archived upon deletion!");
//       
//       
//       
//    }
...
//       Assert.assertTrue(feedArchiveFinalState.equals(feedArchiveInitialState),"The process store values are not the same!");
// 
//       
//    }
//    
