...
public class PrismFeedScheduleTest {
	...
	public void testName(Method method)
	{
        ...
        public void testFeedScheduleOn1ColoWhileAnotherColoHasSuspendedFeed(Bundle bundle) throws Exception
        {
            try{
 ...
 /*       @Test(dataProvider="DP",groups={"prism","0.2"})
        ...
        public void testScheduleAlreadyScheduledFeedOnBothColos(Bundle bundle) throws Exception
        {
            ...
            Util.assertSucceeded(prismHelper.getFeedHelper().schedule(URLS.SCHEDULE_URL,UA1Bundle.getDataSets().get(0)));
            ...
            Util.assertSucceeded(prismHelper.getFeedHelper().schedule(URLS.SCHEDULE_URL,UA2Bundle.getDataSets().get(0)));
        ...
        public void testScheduleSuspendedFeedOnBothColos(Bundle bundle) throws Exception
        {
            ...
            Assert.assertTrue(Util.getOozieFeedJobStatus(Util.readDatasetName(UA2Bundle.getDataSets().get(0)),"RUNNING",UA2ColoHelper).get(0).contains("RUNNING"));
            //now check if they have been scheduled correctly or not
            Util.assertSucceeded(UA1ColoHelper.getFeedHelper().schedule(URLS.SCHEDULE_URL,UA1Bundle.getDataSets().get(0)));
            Assert.assertEquals(Util.getBundles(UA1ColoHelper,Util.readDatasetName(UA1Bundle.getDataSets().get(0)),"feed").size(),1);
            Assert.assertTrue(Util.getOozieFeedJobStatus(Util.readDatasetName(UA1Bundle.getDataSets().get(0)),"SUSPENDED",UA1ColoHelper).get(0).contains("SUSPENDED"));
            Util.assertSucceeded(prismHelper.getFeedHelper().schedule(URLS.SCHEDULE_URL,UA1Bundle.getDataSets().get(0)));
            Assert.assertEquals(Util.getBundles(UA1ColoHelper,Util.readDatasetName(UA1Bundle.getDataSets().get(0)),"feed").size(),1);
            ...
            Util.assertSucceeded(UA2ColoHelper.getFeedHelper().schedule(URLS.SCHEDULE_URL,UA2Bundle.getDataSets().get(0)));
            Assert.assertEquals(Util.getBundles(UA2ColoHelper,Util.readDatasetName(UA2Bundle.getDataSets().get(0)),"feed").size(),1);
        ...
        public void testScheduleDeletedFeedOnBothColos(Bundle bundle) throws Exception
        {
            ...
            Util.assertFailed(prismHelper.getFeedHelper().schedule(URLS.SCHEDULE_URL,UA1Bundle.getDataSets().get(0)));
            Util.assertFailed(prismHelper.getFeedHelper().schedule(URLS.SCHEDULE_URL,UA2Bundle.getDataSets().get(0)));
        ...
        @Test(dataProvider="DP",groups={"prism","0.2"})
        public void testFeedScheduleOn1ColoWhileAnotherColoHasKilledFeed(Bundle bundle) throws Exception
        {
            try{
            Bundle UA1Bundle=new Bundle(bundle,UA1ColoHelper.getEnvFileName());
            Bundle UA2Bundle=new Bundle(bundle,UA2ColoHelper.getEnvFileName());
        ...
        @Test(dataProvider="DP",groups={"prism","0.2"})
        public void testScheduleAlreadyScheduledFeedOnBothColosUsingColoHelper(Bundle bundle) throws Exception
        {
            Bundle UA1Bundle=new Bundle(bundle,UA1ColoHelper.getEnvFileName());
            Bundle UA2Bundle=new Bundle(bundle,UA2ColoHelper.getEnvFileName());
        ...
        @Test(dataProvider="DP",groups={"prism","0.2"})
        public void testScheduleSuspendedFeedOnBothColosUsingColoHelper(Bundle bundle) throws Exception
        {
            Bundle UA1Bundle=new Bundle(bundle,UA1ColoHelper.getEnvFileName());
            Bundle UA2Bundle=new Bundle(bundle,UA2ColoHelper.getEnvFileName());
        ...
        public void testScheduleDeletedFeedOnBothColosUsingColoHelper(Bundle bundle) throws Exception
        {
            ...
            Util.assertFailed(UA1ColoHelper.getFeedHelper().schedule(URLS.SCHEDULE_URL,UA1Bundle.getDataSets().get(0)));
            Util.assertFailed(UA2ColoHelper.getFeedHelper().schedule(URLS.SCHEDULE_URL,UA2Bundle.getDataSets().get(0)));
            
        } 
        
        
        @Test(dataProvider="DP",groups={"prism","0.2"})
        public void testScheduleNonExistentFeedOnBothColosUsingColoHelper(Bundle bundle) throws Exception
        {
            Bundle UA1Bundle=new Bundle(bundle,UA1ColoHelper.getEnvFileName());
            Bundle UA2Bundle=new Bundle(bundle,UA2ColoHelper.getEnvFileName());
        ...
        @Test(dataProvider="DP",groups={"prism","0.2"})
        public void testFeedScheduleOn1ColoWhileOtherColoIsDownUsingColoHelper(Bundle bundle) throws Exception
        {
            try{
            Bundle UA1Bundle=new Bundle(bundle,UA1ColoHelper.getEnvFileName());
            Bundle UA2Bundle=new Bundle(bundle,UA2ColoHelper.getEnvFileName());
...
//        } 
        ...
        @Test(dataProvider="DP",groups={"prism","0.2"})
        public void testFeedScheduleOn1ColoWhileAnotherColoHasSuspendedFeedUsingColoHelper(Bundle bundle) throws Exception
        {
            try{
            Bundle UA1Bundle=new Bundle(bundle,UA1ColoHelper.getEnvFileName());
            Bundle UA2Bundle=new Bundle(bundle,UA2ColoHelper.getEnvFileName());
        ...
        @Test(dataProvider="DP",groups={"prism","0.2"})
        public void testFeedScheduleOn1ColoWhileAnotherColoHasKilledFeedUsingColoHelper(Bundle bundle) throws Exception
        {
            try{
            Bundle UA1Bundle=new Bundle(bundle,UA1ColoHelper.getEnvFileName());
            Bundle UA2Bundle=new Bundle(bundle,UA2ColoHelper.getEnvFileName());
