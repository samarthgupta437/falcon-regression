...
public class PrismProcessScheduleTest {
	...
	public void testName(Method method)
	{
        ...
        public void testScheduleAlreadyScheduledProcessOnBothColos(Bundle bundle) throws Exception
        {
            ...
            Util.assertSucceeded(UA2ColoHelper.getProcessHelper().schedule(URLS.SCHEDULE_URL,UA2Bundle.getProcessData()));
            //now check if they have been scheduled correctly or not
            Assert.assertTrue(Util.getOozieJobStatus(Util.readEntityName(UA1Bundle.getProcessData()),"RUNNING",UA1ColoHelper).get(0).contains("RUNNING"));
            Assert.assertTrue(Util.getOozieJobStatus(Util.readEntityName(UA2Bundle.getProcessData()),"RUNNING",UA2ColoHelper).get(0).contains("RUNNING"));
        ...
        public void testScheduleSuspendedProcessOnBothColos(Bundle bundle) throws Exception
        {
            ...
            Util.assertSucceeded(UA1ColoHelper.getProcessHelper().schedule(URLS.SCHEDULE_URL,UA1Bundle.getProcessData()));
            Assert.assertTrue(Util.getOozieJobStatus(Util.readEntityName(UA1Bundle.getProcessData()),"SUSPENDED",UA1ColoHelper).get(0).contains("SUSPENDED"));
            Util.assertSucceeded(UA1ColoHelper.getProcessHelper().resume(URLS.RESUME_URL,UA1Bundle.getProcessData()));
            Assert.assertTrue(Util.getOozieJobStatus(Util.readEntityName(UA1Bundle.getProcessData()),"RUNNING",UA1ColoHelper).get(0).contains("RUNNING"));
        ...
        public void testScheduleDeletedProcessOnBothColos(Bundle bundle) throws Exception
        {
            ...
            Util.assertFailed(UA1ColoHelper.getProcessHelper().schedule(URLS.SCHEDULE_URL,UA1Bundle.getProcessData()));
            Util.assertFailed(UA2ColoHelper.getProcessHelper().schedule(URLS.SCHEDULE_URL,UA2Bundle.getProcessData()));
        ...
        public void testProcessScheduleOn1ColoWhileThatColoIsDown(Bundle bundle) throws Exception
        {
            ...
            Util.assertFailed(prismHelper.getProcessHelper().schedule(URLS.SCHEDULE_URL,UA1Bundle.getProcessData()));
            Util.verifyNoJobsFoundInOozie(Util.getOozieJobStatus(Util.readEntityName(UA1Bundle.getProcessData()),"RUNNING",UA2ColoHelper));
            }
            catch(Exception e)
            {
        ...
        public void testProcessScheduleOn1ColoWhileAnotherColoHasSuspendedProcess(Bundle bundle) throws Exception
        {
            ...
            submitAndScheduleProcess(UA1Bundle);
            Util.assertSucceeded(UA1Bundle.getProcessHelper().suspend(URLS.SUSPEND_URL,UA1Bundle.getProcessData()));
            Assert.assertTrue(Util.getOozieJobStatus(Util.readEntityName(UA1Bundle.getProcessData()),"SUSPENDED",UA1ColoHelper).get(0).contains("SUSPENDED"));
