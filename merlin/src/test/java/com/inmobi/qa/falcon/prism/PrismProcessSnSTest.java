...
public class PrismProcessSnSTest {
	...
	public void testName(Method method)
	{
        ...
        public void testProcessSnSOnBothColos(Bundle bundle) throws Exception
        {
            ...
            Util.verifyNoJobsFoundInOozie(Util.getOozieJobStatus(Util.readEntityName(UA2Bundle.getProcessData()),"RUNNING",UA1ColoHelper));
            ...
            ServiceResponse response=prismHelper.getProcessHelper().getStatus(URLS.STATUS_URL,UA2Bundle.getProcessData());
            System.out.println(response.getMessage());
            Util.verifyNoJobsFoundInOozie(Util.getOozieJobStatus(Util.readEntityName(UA1Bundle.getProcessData()),"RUNNING",UA2ColoHelper));
        ...
        @Test(dataProvider="DP",groups={"prism","0.2"})
        public void testProcessSnSForSubmittedProcessOnBothColosUsingColoHelper(Bundle bundle) throws Exception
        {
            Bundle UA1Bundle=new Bundle(bundle,UA1ColoHelper.getEnvFileName());
            Bundle UA2Bundle=new Bundle(bundle,UA2ColoHelper.getEnvFileName());
        ...
        public void testProcessSnSAlreadyScheduledOnBothColos(Bundle bundle) throws Exception
        {
            ...
            Util.assertSucceeded(UA1ColoHelper.getProcessHelper().schedule(URLS.SCHEDULE_URL,UA1Bundle.getProcessData()));
        ...
        public void testSnSDeletedProcessOnBothColos(Bundle bundle) throws Exception
        {
            ...
            Assert.assertEquals(Util.parseResponse(prismHelper.getProcessHelper().getStatus(URLS.STATUS_URL,UA1Bundle.getProcessData())).getMessage(),"ua1/RUNNING");
            ...
            Util.assertSucceeded(prismHelper.getProcessHelper().delete(URLS.DELETE_URL,UA1Bundle.getProcessData()));
            ...
            Util.assertSucceeded(prismHelper.getProcessHelper().delete(URLS.DELETE_URL,UA2Bundle.getProcessData()));
        ...
        public void testScheduleNonExistentProcessOnBothColos(Bundle bundle) throws Exception
        {
            ...
            Assert.assertEquals(Util.parseResponse(UA1ColoHelper.getProcessHelper().submitAndSchedule(URLS.SUBMIT_AND_SCHEDULE_URL,UA1Bundle.getProcessData())).getStatusCode(),404);
            Assert.assertEquals(Util.parseResponse(UA2ColoHelper.getProcessHelper().submitAndSchedule(URLS.SUBMIT_AND_SCHEDULE_URL,UA2Bundle.getProcessData())).getStatusCode(),404);
...
//            Util.shutDownService(UA1ColoHelper.getProcessHelper());
//            
//            Util.assertFailed(prismHelper.getProcessHelper().submitAndSchedule(URLS.SUBMIT_AND_SCHEDULE_URL,UA1Bundle.getProcessData()));
//            Util.verifyNoJobsFoundInOozie(Util.getOozieJobStatus(Util.readEntityName(UA1Bundle.getProcessData()),"RUNNING",UA2ColoHelper));
//            }
//            catch(Exception e)
//            {
...
//        
//        @Test(dataProvider="DP",groups={"prism","0.2"})
//        public void testProcessScheduleOn1ColoWhileAnotherColoHasSuspendedProcess(Bundle bundle) throws Exception
//        {
//            try{
//            Bundle UA1Bundle=new Bundle(bundle,UA1ColoHelper.getEnvFileName());
//            Bundle UA2Bundle=new Bundle(bundle,UA2ColoHelper.getEnvFileName());
...
//
//        @Test(dataProvider="DP",groups={"prism","0.2"})
//        public void testProcessScheduleOn1ColoWhileAnotherColoHasKilledProcess(Bundle bundle) throws Exception
//        {
//            try{
//            Bundle UA1Bundle=new Bundle(bundle,UA1ColoHelper.getEnvFileName());
//            Bundle UA2Bundle=new Bundle(bundle,UA2ColoHelper.getEnvFileName());
...
//        } 
    ...
    private void submitAndScheduleProcess(Bundle bundle) throws Exception
    {
        ...
        Util.assertSucceeded(prismHelper.getProcessHelper().submitAndSchedule(Util.URLS.SUBMIT_AND_SCHEDULE_URL,bundle.getProcessData()));
    } 
