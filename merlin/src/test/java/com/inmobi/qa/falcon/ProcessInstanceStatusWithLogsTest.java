...
//			Thread.sleep(180000);
//			
//			//ProcessInstancesResult r  = processHelper.getProcessInstanceKill(Util.readEntityName(b.getProcessData()),"?start=2010-01-02T11:00Z&type=DEFAULT");
//			//Thread.sleep(30000);
//
//			
//			
//			if(!instanceUtil.getInstanceStatus(Util.readEntityName(b.getProcessData()), 0, 0).equals(CoordinatorAction.Status.KILLED))
//				Assert.assertTrue(false);
//			
//			
//			ProcessInstancesResult r  = processHelper.getProcessInstanceStatus(Util.readEntityName(b.getProcessData()),"?start=2010-01-02T11:00Z&type=DEFAULT");
//
...
//			
//			
//			 r  = processHelper.getProcessInstanceStatus(Util.readEntityName(b.getProcessData()),"?start=2010-01-02T11:00Z&type=DEFAULT");
//
//			instanceUtil.verifyStatusLog(r);
//			instanceUtil.validateResponse(r,1,0,0,0,1);
//
...
//			Thread.sleep(30000);
//			
//			ProcessInstancesResult r  = processHelper.getProcessInstanceSuspend(Util.readEntityName(b.getProcessData()),"?start=2010-01-02T11:00Z&type=DEFAULT");
//			Thread.sleep(30000);
//
//			
//			for(int i =0 ;  i <30 ; i++)
//			{
//				if(instanceUtil.getInstanceStatus(Util.readEntityName(b.getProcessData()), 0, 0).equals(CoordinatorAction.Status.SUSPENDED))
//					break;
//			}
//			
//			 r  = processHelper.getProcessInstanceStatus(Util.readEntityName(b.getProcessData()),"?start=2010-01-02T11:00Z&type=DEFAULT");
...
//			for(int i =0 ;  i <30 ; i++)
//			{
//				if(instanceUtil.getInstanceStatus(Util.readEntityName(b.getProcessData()), 0, 0).equals(CoordinatorAction.Status.RUNNING))
//					break;
//			}
//			
//			ProcessInstancesResult r  = processHelper.getProcessInstanceStatus(Util.readEntityName(b.getProcessData()),"?start=2010-01-02T11:00Z&type=DEFAULT");
...
//			b = (Bundle)Util.readELBundles()[0][0];
//			b.generateUniqueBundle();
//			b.setInputFeedDataPath("/samarthData/invalidPath/${YEAR}/${MONTH}/${DAY}/${HOUR}/${MINUTE}");
//			b.setProcessValidity("2010-01-02T11:00Z","2010-01-02T11:06Z");
//			b.setProcessPeriodicity(5,TimeUnit.minutes);
//			b.submitAndScheduleBundle(prismHelper);
//			Thread.sleep(60000);
...
//			
//			ProcessInstancesResult r  = processHelper.getProcessInstanceStatus(Util.readEntityName(b.getProcessData()),"?start=2010-01-02T11:00Z&end=2010-01-02T11:05Z&type=DEFAULT");
//			
//			instanceUtil.verifyStatusLog(r);
...
//
//				r  = processHelper.getProcessInstanceStatus(Util.readEntityName(b.getProcessData()),"?start=2010-01-02T11:00Z&end=2010-01-02T11:05Z&type=DEFAULT");
//
//				s=instanceUtil.getDefaultCoordinatorStatus(Util.getProcessName(b.getProcessData()),0);
//				if(s.equals(org.apache.oozie.client.Job.Status.SUCCEEDED) || s.equals(org.apache.oozie.client.Job.Status.DONEWITHERROR))
//					break;
//				
//				Thread.sleep(30000);
//				
...
//			b.submitAndScheduleBundle(prismHelper);
//			Util.print("status immediately after schedule");
//			ProcessInstancesResult r  = processHelper.getProcessInstanceStatus(Util.readEntityName(b.getProcessData()),"?start=2010-01-02T11:00Z&end=2010-01-02T11:05Z");
//			Thread.sleep(20000);
//			
//			
// 			processHelper.getProcessInstanceKill(Util.readEntityName(b.getProcessData()),"?start=2010-01-02T11:00Z&end=2010-01-02T11:05Z");
//			
//			Thread.sleep(30000);
//			
//			
//			
//			r  = processHelper.getProcessInstanceStatus(Util.readEntityName(b.getProcessData()),"?start=2010-01-02T11:00Z&end=2010-01-02T11:05Z");
//			//instanceUtil.validateResponse(r, 2, 0, 0, 0,0);
//			
//			processHelper.getProcessInstanceRerun(Util.readEntityName(b.getProcessData()),"?start=2010-01-02T11:00Z&end=2010-01-02T11:05Z");
//			r  = processHelper.getProcessInstanceStatus(Util.readEntityName(b.getProcessData()),"?start=2010-01-02T11:00Z&end=2010-01-02T11:05Z&runid=1");
//
//			
//			
//		}
