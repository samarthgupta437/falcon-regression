...
public class LateDataPrismTest {
    ...
    public void testLateDataWithCutOffInFutureAndExponentialPolicyWithRerunBeyondLimit(Bundle bundle) throws Exception
    {
        ...
        bundle=new Bundle(bundle,UA3ColoHelper);
            ...
            Util.assertSucceeded(UA3ColoHelper.getProcessHelper().schedule(URLS.SCHEDULE_URL,bundle.getProcessData()));
        
            //attach the consumer
            Consumer consumer=new Consumer("IVORY."+Util.readEntityName(bundle.getProcessData()),UA3ColoHelper.getClusterHelper().getActiveMQ());
            consumer.start();
        ...
        insertionFolder=Util.findFolderBetweenGivenTimeStamps(startDate,now.plusMinutes(Integer.parseInt(delay)),initialData);
        ...
        for(int i=1;i<=4;i++)
        {
            ...
            {
                //System.out.println("waiting for relevant workflows to be over before inserting folder "+insertionFolder);
                //keep waiting
            	Thread.sleep(20000);
            }
        ...
        while(consumer.getMessageData().size()!=expectedsize+1 )
        {
            ...
            {
                throw new TestNGException("extra data received in queue! some problem is there. please check!");
            }
            //keep waiting baby
            Thread.sleep(1000);
        ...
        parseConsumerOutput(UA3ColoHelper,bundle.getProcessObject(),consumer.getMessageData(),expectedsize+1,insertionFolder,expectedsize+1);
  ...
  /*  
    ...
    @Test(groups = {"0.2"},dataProvider="DP",priority=-20)
    public void testLateDataWithCutOffInFutureAndBackOffPolicyAndAlternateDataInsertion(Bundle bundle) throws Exception
    {
        System.setProperty("java.security.krb5.realm", "");
        System.setProperty("java.security.krb5.kdc", "");
        String delay ="10";
    ...
    @Test(groups = {"0.2"},dataProvider="DP",priority=-20)
    public void testLateDataWithBackOffPolicyAndDataInsertedAfterLastCheck(Bundle bundle) throws Exception
    {
        System.setProperty("java.security.krb5.realm", "");
        System.setProperty("java.security.krb5.kdc", "");
        String delay ="5";
        ...
        int expectedsize=0;
            ...
            while(!(allRelevantWorkflowsAreOver(UA3ColoHelper,bundleId, insertionFolder) && lastCheck.isBefore(new DateTime(DateTimeZone.UTC))))
            {
                //System.out.println("waiting for relevant workflows to be over before inserting folder "+insertionFolder);
                //keep waiting
        ...
        //now parse the goddamn consumer data for info
        parseConsumerOutput(UA3ColoHelper,bundle.getProcessObject(),consumer.getMessageData(),expectedsize+1,insertionFolder,1);
    ...
    @Test(groups = {"0.2"},dataProvider="DP",priority=-20)
    public void testLateDataWithBackOffPolicyAndInstanceRunOverlappingOverAnotherPass(Bundle bundle) throws Exception
    {
        System.setProperty("java.security.krb5.realm", "");
        System.setProperty("java.security.krb5.kdc", "");
        String delay ="5";
        ...
        int expectedsize=1;
            ...
            System.out.println("Going to check on process @....."+DateTime.now(DateTimeZone.UTC).toString());
            ...
            //Assert.assertTrue(Util.getOozieJobStatus(Util.readEntityName(bundle.getProcessData()),"RUNNING", UA3ColoHelper).get(0).contains("RUNNING"));
            Assert.assertEquals(Util.getRunIdOfSpecifiedInstance(1, bundleId, UA3ColoHelper),1,"run id was not correct!!!");
        ...
        //now parse the goddamn consumer data for info
        parseConsumerOutput(UA3ColoHelper,bundle.getProcessObject(),consumer.getMessageData(),expectedsize+1,insertionFolder,2);
    ...
    @Test(groups = {"0.2"},dataProvider="DP",priority=-20)
    public void testLateDataWithExponentialPolicyAndDataInsertedAfterLastCheck(Bundle bundle) throws Exception
    {
        System.setProperty("java.security.krb5.realm", "");
        System.setProperty("java.security.krb5.kdc", "");
        String delay ="5";
    ...
    @Test(groups = {"0.2"},dataProvider="DP",priority=-20)
    public void testLateDataWithExponentialPolicyAndInstanceRunOverlappingOverAnotherPass(Bundle bundle) throws Exception
    {
        System.setProperty("java.security.krb5.realm", "");
        System.setProperty("java.security.krb5.kdc", "");
        String delay ="5";
    ...
    @Test(groups = {"0.2"},dataProvider="DP",priority=-20)
    public void testLateDataWithFinalPolicyAndDataInsertedAfterLastCheck(Bundle bundle) throws Exception
    {
        System.setProperty("java.security.krb5.realm", "");
        System.setProperty("java.security.krb5.kdc", "");
        String delay ="5";
        ...
        int expectedsize=0;
            ...
            Assert.assertEquals(consumer.getMessageData().size(),1,"where is the first response btw!!!");
            System.out.println("going to insert data at: "+insertionFolder);
            insertionTime=new DateTime(DateTimeZone.UTC);
            System.out.println("insertion time is :"+insertionTime);
            Util.injectMoreData(UA3ColoHelper,insertionFolder,"src/test/resources/OozieExampleInputData/lateData");
    ...
    @Test(groups = {"0.2"},dataProvider="DP",priority=-20)
    public void testLateDataWithFinalPolicyAndInstanceRunOverlappingOverAnotherPass(Bundle bundle) throws Exception
    {
        System.setProperty("java.security.krb5.realm", "");
        System.setProperty("java.security.krb5.kdc", "");
        String delay ="1";
...
////        
////        //now parse the goddamn consumer data for info
////        parseConsumerOutput(UA3ColoHelper,bundle.getProcessObject(),consumer.getMessageData(),expectedsize-skippedInstances+1,insertionFolder,expectedsize-skippedInstances+1);
////        
////        
////        consumer.stop();
////        
...
//    
    ...
    public void testLateDataWithCutOffInFutureAndPeriodicToExponentialUpdatePolicy(Bundle bundle) throws Exception
    {
        System.setProperty("java.security.krb5.realm", "");
        System.setProperty("java.security.krb5.kdc", "");
        String delay ="10";
        ...
        for(int i=1;i<=5;i++)
        {
            ...
            while(!allRelevantWorkflowsAreOver(UA3ColoHelper,bundleId, insertionFolder))
            {
                ...
                if(i==3)
                {
                    ...
                    Util.assertSucceeded(prismHelper.getProcessHelper().update(bundle.getProcessData(),bundle.getProcessData()));
                    updated=true;
                }
    ...
    {
        ArrayList<String> relevantFlowList=getAllRelevantWorkflows(UA3ColoHelper,instanceUtil.getLatestBundleID(UA3ColoHelper,processObject.getName(),"process"),insertionFolder);
        
        
        //check that all such flows are present in the consumer list for the expected number of times i.e no messages are missing
        for(String id:relevantFlowList)
        {
            ...
            Assert.assertEquals(count,expectedCountForEachInstance,"workflow id: "+id+" did not have expected number of data in the queue!!!");
            Assert.assertEquals(runId,expectedCountForEachInstance-1,"workflow id: "+id+" did not have expected number of runs in the queue!!!");
        }
	...
	private boolean allRelevantWorkflowsAreOver(PrismHelper prismHelper,String bundleId,String insertionFolder) throws Exception
	{
			...
			if(job.getAppName().contains("DEFAULT"))
			{
				...
				for(CoordinatorAction action:coordJob.getActions())
				{
                                   //     CoordinatorAction actionMan=oozieClient.getCoordActionInfo(action.getId());
                                        ...
                                        CoordinatorAction actionMan= coordJob.getActions().get(action.getActionNumber()-1);
                                        
                                      
                                        
                                        if(!(actionMan.getStatus().equals(CoordinatorAction.Status.WAITING) || actionMan.getStatus().equals(CoordinatorAction.Status.READY) || actionMan.getStatus().equals(CoordinatorAction.Status.SUBMITTED) ))
                                        {
                                        	
                                        	  WorkflowJob j = oozieClient.getJobInfo(action.getExternalId());
                                              
                                             // Util.print(" j conf: "+ j.getConf());
                                        	
                                     
                                        	
                                            if(getRunConfInputString(j.getConf()).contains(insertionFolder))
                                            {
                                                ...
                                                {
                                                    System.out.println("found folder "+insertionFolder+" in workflow: "+actionMan.getId());
                                                    System.out.println("related workflow "+actionMan.getId()+" is over....");
                                                    workflowStatusMap.put(actionMan.getId(), Boolean.TRUE);
                                                }
                                            else
                                            {
                                                workflowStatusMap.put(action.getId(), Boolean.FALSE);
                                            }
                                        }
	...
	private ArrayList<String> getAllRelevantWorkflows(PrismHelper prismHelper,String bundleId,String insertionFolder) throws Exception
	{
			...
			if(job.getAppName().contains("DEFAULT"))
			{
				...
				for(CoordinatorAction action:coordJob.getActions())
				{
                                        ...
                                        if(!(actionMan.getStatus().equals(CoordinatorAction.Status.WAITING) || actionMan.getStatus().equals(CoordinatorAction.Status.READY) || actionMan.getStatus().equals(CoordinatorAction.Status.SUBMITTED) ))
                                        {
                                            ...
                                            if(getRunConfInputString(oozieClient.getJobInfo(action.getExternalId()).getConf()).contains(insertionFolder))
                                            {
