...
public class PrismClusterDeleteTest {
    ...
    public void testUA1ClusterDeleteInBothColos(Bundle bundle) throws Exception {
        ...
        Util.assertSucceeded(
                (prismHelper.getClusterHelper()
                        .submitEntity(Util.URLS.SUBMIT_URL, UA1Bundle.getClusters().get(0))));
        ...
        Util.assertSucceeded(
                prismHelper.getClusterHelper()
                        .delete(Util.URLS.DELETE_URL, UA1Bundle.getClusters().get(0)));
    ...
    @Test(dataProvider = "DP", groups = {"multiCluster"})
    public void testUA1ClusterDeleteTwiceWhen1ColoIsDownDuring1stDelete(Bundle bundle)
    throws Exception {
        try {
            //create a UA1 bundle
            Bundle UA1Bundle = new Bundle(bundle, UA1ColoHelper.getEnvFileName());
            ...
            //Assert.assertTrue(Arrays.deepEquals(initialPrismStore.toArray(new
            // String[initialPrismStore.size()]),
            // finalPrismStore.toArray(new String[finalPrismStore.size()])));
            //Assert.assertTrue(Arrays.deepEquals(initialPrismArchiveStore.toArray(new
            // String[initialPrismArchiveStore.size()]),finalPrismArchiveStore.toArray(new
            // String[finalPrismArchiveStore.size()])));
    ...
    @Test(dataProvider = "DP", groups = {"multiCluster"})
    public void testUA1ClusterDeleteNonExistentWhen1ColoIsDownDuringDelete(Bundle bundle)
    throws Exception {
        try {
            //create a UA1 bundle
            Bundle UA1Bundle = new Bundle(bundle, UA1ColoHelper.getEnvFileName());
            ...
            Assert.assertTrue(
                    Arrays.deepEquals(UA2StorePostUp.toArray(new String[UA2StorePostUp.size()]),
                            finalUA2Store.toArray(new String[finalUA2Store.size()])));
            Assert.assertTrue(
                    Arrays.deepEquals(UA2ArchivePostUp.toArray(new String[UA2ArchivePostUp.size()]),
                            finalUA2ArchiveStore.toArray(new String[finalUA2ArchiveStore.size()])));
