...
public class PrismProcessSuspendTest extends BaseTestClass {
    ...
    public void testSuspendSuspendedProcessOnBothColosWhen1ColoIsDown() throws Exception {
        ...
        AssertUtil.assertSucceeded(prism.getProcessHelper().suspend(Util.URLS.SUSPEND_URL, bundles[0].getProcessData()));
        //verify
        ...
        AssertUtil.assertFailed(prism.getProcessHelper().suspend(Util.URLS.SUSPEND_URL, bundles[0].getProcessData()));

        for (int i = 0; i < 2; i++) {
            //suspend on the other one
            AssertUtil.assertSucceeded(prism.getProcessHelper().suspend(Util.URLS.SUSPEND_URL, bundles[1].getProcessData()));
            AssertUtil.checkStatus(cluster1OC, ENTITY_TYPE.PROCESS, bundles[0], Job.Status.SUSPENDED);
    ...
    public void testSuspendDeletedProcessOnBothColos() throws Exception {
        ...
        AssertUtil.assertSucceeded(prism.getProcessHelper().delete(Util.URLS.DELETE_URL, bundles[0].getProcessData()));
        ...
        AssertUtil.assertSucceeded(prism.getProcessHelper().delete(Util.URLS.DELETE_URL, bundles[1].getProcessData()));
        //suspend on the other one
        AssertUtil.assertFailed(prism.getProcessHelper().suspend(Util.URLS.SUSPEND_URL, bundles[1].getProcessData()));
        AssertUtil.checkStatus(cluster1OC, ENTITY_TYPE.PROCESS, bundles[0], Job.Status.KILLED);
    ...
    public void testSuspendNonExistentProcessOnBothColos() throws Exception {
        ...
        AssertUtil.assertFailed(cluster1.getProcessHelper().suspend(Util.URLS.SUSPEND_URL, bundles[0].getProcessData()));
        AssertUtil.assertFailed(cluster2.getProcessHelper().suspend(Util.URLS.SUSPEND_URL, bundles[0].getProcessData()));
    }
    ...
    public void testSuspendSubmittedProcessOnBothColos() throws Exception {
        ...
        AssertUtil.assertFailed(cluster1.getProcessHelper().suspend(Util.URLS.SUSPEND_URL, bundles[0].getProcessData()));
        AssertUtil.assertFailed(cluster2.getProcessHelper().suspend(Util.URLS.SUSPEND_URL, bundles[1].getProcessData()));
    }
